...
This role is "frontline": you'll work directly with customers (often onsite), translate business reality into bot workflows, handle prompt engineering + knowledge grounding, ship deployments, and iterate until it works reliably in production.
...
- Run workshops to capture processes, FAQs, edge cases, and success metrics
- Drive the go-live process from requirements through monitoring and improvement
...
- Build structured conversational flows: intents, entities, routing, handoff, and compliant responses
- Create reusable prompt patterns and "prompt packs"

### Testing, Debugging & Iteration
- Analyze logs to find failure modes (misclassification, hallucination, poor handling)
- Create test sets ("golden conversations"), run regressions, and measure improvements
- Coordinate with Product/Engineering for platform needs
